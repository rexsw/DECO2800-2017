...
public class Bunker extends BaseEntity implements Clickable, Tickable, HasProgress, HasOwner {
	...
	public Bunker(BaseWorld world, int posX, int posY, int posZ) {
	...
	public void onClick(MouseHandler handler) {
		...
		System.out.println("Bunker got clicked");
